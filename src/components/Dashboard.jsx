...
const Dashboard = () => {
  return (
    <div className="min-h-screen w-full text-white flex flex-col px-6 py-10 animate-fade-in">
      {/* HEADER */}
      <h1 className="text-4xl font-extrabold text-center bg-gradient-to-r from-pink-500 to-red-500 bg-clip-text text-transparent tracking-wide">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
        ...
        <Link
          ...
          hover:border-pink-500/40 hover:shadow-[0_0_25px_rgba(255,0,130,0.45)] transition-all"
        >
        ...
        <Link
          ...
          hover:border-pink-500/40 hover:shadow-[0_0_25px_rgba(255,0,130,0.45)] transition-all"
        >
          <h2 className="text-2xl font-bold mb-2 text-pink-400">Likes</h2>
          <p className="text-gray-300 text-sm">People who liked you</p>
        </Link>
